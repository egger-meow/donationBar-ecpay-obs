...
- No alert exercise has been run against the wired webhook yet; the template in [ALERT_EXERCISE_TEMPLATE.md](ALERT_EXERCISE_TEMPLATE.md) is unused until one is. Delivery is unit-tested (Section 4d) but not yet exercised against a real endpoint in staging.
